        ...
        <div className="space-y-3">
          {requests.map((r) => (
            <Link
              ...
              className="group flex items-start justify-between gap-3 rounded-[24px] border border-ink/10 bg-surface p-5 shadow-[0_1px_3px_rgba(16,24,5,0.05)] transition-all hover:-translate-y-0.5 hover:border-ink/20 hover:shadow-[0_12px_32px_-10px_rgba(16,24,5,0.18)]"
            >
              ...
              <span className="shrink-0 rounded-full border border-ink/15 px-4 py-2 text-[12px] font-bold text-text-secondary transition-colors group-hover:border-ink/30 group-hover:text-text-primary">
                View →
              </span>
            </Link>
          ))}
